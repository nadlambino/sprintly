...
namespace NadLambino\Uploadable\Facades {
     ...
     */        class Uploadable {
         ...
         * @static 
         */        public static function upload($file, $path = null, $name = null)
        {
                        /** @var \NadLambino\Uploadable\Uploadable $instance */
                        return $instance->upload($file, $path, $name);
        }
                    /**
         ...
         * @static 
         */        public static function temporaryUrl($file, $expiration = 60, $options = [])
        {
                        /** @var \NadLambino\Uploadable\Uploadable $instance */
                        return $instance->temporaryUrl($file, $expiration, $options);
        }
                    /**
         * Delete a file.
         *
...
namespace  {
            ...
            class Uploadable extends \NadLambino\Uploadable\Facades\Uploadable {}
    }
